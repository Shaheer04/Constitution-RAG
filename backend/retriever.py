"""
Retriever Component with Hybrid Retrieval and Reranking Capabilities
"""
...
class Retriever:
    ...
    def __init__(self,
        ...
        embedding_model_name = embedding_model_name or settings.embed_model
        chroma_db_path = chroma_db_path or str(settings.chroma_dir)
        collection_name = collection_name or settings.collection_name

        self.embedding_model = SentenceTransformer(embedding_model_name)
        self.db_manager = ChromaDBManager(chroma_db_path, collection_name)
